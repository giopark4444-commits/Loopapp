...
>
> ```bash
> cd decibel-meter && python3 -m http.server 8000
...
- **Modo de calibración**: introduce el valor de un sonómetro de referencia y
  la app ajusta el offset para mostrar dB SPL reales. También hay un deslizador
  manual. La calibración se guarda en `localStorage`.
...
una app de referencia) en el mismo lugar. Los valores de referencia típicos:
