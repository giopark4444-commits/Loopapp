...
function seed() {
  ...
  return [
    ...
    { id: uid(), title: 'Spotify',     category: 'subs',    icon: 'music',    amount: 11.99, currency: 'EUR', autoPay: true,  recurrence: 'monthly', nextDate: d(12), notifyDaysBefore: 5, history: [] },
...
function renderLoops(v) {
  ...
  const sel = v.querySelector('#loop-sort'); sel.onchange = () => { loopSort = sel.value; render(); };
  bindRows(v);
}
